...
namespace Homework_6
{
    internal class Program
    {
        ...
        {
            //Programm 1
            var planet1 = new { Name = "Венера", Number = 2, Length = 38025, PreviousPlanet = ""};
            ...
            var planet4 = new { Name = "Венера", Number = 2, Length = 38025, PreviousPlanet = "" };
           
            Console.WriteLine($"Имя планеты = {planet1.Name}, Порядковый номер от Солнца = {planet1.Number}, Длина экватора = {planet1.Length}");
            ...
            Console.WriteLine($"Имя планеты = {planet4.Name}, Порядковый номер от Солнца = {planet4.Number}, Длина экватора = {planet4.Length}");
            Console.WriteLine("Это планета Венера? " + planet1.Equals(planet4));

            Console.WriteLine("\n");
            //Programm 2
            PlanetsCatalog planetsCatalog = new PlanetsCatalog();            
            var result1 = planetsCatalog.GetPlanet("Земля");
            Console.WriteLine(result1);
            var result2 = planetsCatalog.GetPlanet("Лимония");
            Console.WriteLine(result2);           
            var result3 = planetsCatalog.GetPlanet("Марс");
            Console.WriteLine(result3);

            Console.WriteLine("\n");
            //Program 3
            PlanetsCatalogCustom planetsCatalogCustom = new PlanetsCatalogCustom();
            (int, int, string) result4 = planetsCatalogCustom.GetPlanet("Земля", x =>
            {
                count++;
                if (count == 3)
                {
            ...
            (int, int, string) result5 = planetsCatalogCustom.GetPlanet("Лимония", x => {
                count++;
                if (count == 3)
                {
                    count = 0;
            ...
            (int, int, string) result6 = planetsCatalogCustom.GetPlanet("Марс", x => {
                count++;
                if (count == 3)
                {
                    count = 0;
            ...
            (int, int, string) result7 = planetsCatalogCustom.GetPlanet("Лимония", x =>
            {
                if (x == "Лимония")
                {
